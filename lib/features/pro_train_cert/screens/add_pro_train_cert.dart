...
class _AddProTrainCertState extends State<AddProTrainCert> {
  ...
  void initState() {
    ...
    _eqfGrade.text =
        widget.eduEdit == null ? '' : widget.eduEdit!.eqfGrade.toString();
    _eqfLevel.text = widget.eduEdit == null
        ? ''
        : eqfLevel.entries
            .firstWhere((e) => e.key == widget.eduEdit!.eqfLevel)
            .key
            .toString();
    _description.text =
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomDropDown(
                        ...
                        value: widget.eduEdit == null ? null : _eqfGrade.text,
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ListEducation edu = ListEducation(
                              ...
                              eqfGrade: int.parse(_eqfGrade.text),
                            ...
                            if (widget.eduEdit == null) {
                              //
                              MySnackBar.mySnackBar(context, Colors.green,
                                  Icons.check, '${edu.toJson()}');
                            }
                            //Update Edu
                            else {
                              //
